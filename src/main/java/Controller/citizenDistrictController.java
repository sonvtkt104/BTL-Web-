...
@WebServlet(urlPatterns = {"/home/citizendistrict"})
public class citizenDistrictController extends HttpServlet {
    @Override
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        if(cadres != null && cadres.getRank().equals("A3")) {
            ...
            String ID = (!communeID.equals("0") ? ((!villageID.equals("0") ? villageID : communeID)) : districtID);
