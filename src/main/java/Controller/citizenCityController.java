...
@WebServlet(urlPatterns = {"/home/citizencity"})
public class citizenCityController extends HttpServlet {
    @Override
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        if(cadres != null && cadres.getRank().equals("A2")) {
            ...
            String ID = (!districtID.equals("0") ? ((!communeID.equals("0") ? ((!villageID.equals("0") ?
                    villageID : communeID)) : districtID)) : cityID);
